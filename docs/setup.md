...
```bash
uvx --from git+https://github.com/olearydj/course-courier@v0.3.1 ccc plan --config content/PUBLISH.toml
uvx --from git+https://github.com/olearydj/course-courier@v0.3.1 ccc build --config content/PUBLISH.toml --output /tmp/course-public
uvx --from git+https://github.com/olearydj/course-courier@v0.3.1 ccc verify --config content/PUBLISH.toml --output /tmp/course-public
```
...
```bash
uvx --from git+https://github.com/olearydj/course-courier@v0.3.1 ccc init-workflow --config content/PUBLISH.toml --branch main
```
